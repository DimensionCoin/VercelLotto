...
const Swap = () => {
  ...
  return (
    <div className="bg-gradient-to-t from-black via-red-900 to-black min-h-screen flex flex-col">
      <Head >
      ...
      <footer className="border-2 border-red-500/20 items-center text-white justify-between p-5">
        <p className="text-xl text-transparent bg-gradient-to-r from-red-200 to-red-600 bg-clip-text pl-5 text-center flex-1">
        Hello User: {address?.substring(0,5)}...{address?.substring(address.length - 5)}. </p>
        <p className="text-sm text-transparent bg-gradient-to-b from-red-200 to-red-600 bg-clip-text pl-5 text-center flex-1">Lotto256 is intended for entertainment purposes only. By participating in this lottery, you acknowledge and agree to the following:
...
By participating in this lottery, you acknowledge and agree to these terms and conditions, and you release the lottery and its operators from any and all liability arising from your participation in the lottery.
        ...
        <p className="text- text-transparent bg-gradient-to-r from-red-300 to-red-600 bg-clip-text pl-5 text-center flex-1">DO NOT SPEND MORE THEN YOU ARE ARE WILLING TO LOSE.</p>
        <p className="text- text-transparent bg-gradient-to-r from-red-300 to-red-600 bg-clip-text pl-5 text-center flex-1">KNOW YOUR LIMIT, STAY WITHIN IT!</p>
      </footer>
    </div>
  );
}
